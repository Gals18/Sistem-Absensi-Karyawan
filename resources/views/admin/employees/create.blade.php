                            ...
                            <div class="card-body">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('sex')
                                            <div class="text-danger">Please select a valid option</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
...
@section('extra-js')
    {{-- <script>
        $(document).ready(function() {
            // Jika tanggal lahir sudah ada, gunakan format yang sesuai dengan moment.js
            @if (old('dob'))
                const dob = moment('{{ old('dob') }}', 'YYYY-MM-DD');
            @else
                const dob = moment(); // Default tanggal lahir
            @endif

            // Jika tanggal bergabung sudah ada, gunakan format yang sesuai dengan moment.js
            @if (old('join_date'))
                const join_date = moment('{{ old('join_date') }}', 'YYYY-MM-DD');
            @else
                const join_date = moment(); // Default tanggal bergabung
            @endif

            // Inisialisasi datepicker dengan tanggal lahir yang sesuai
            $('#dob').daterangepicker({
                startDate: dob,
            ...
            // Inisialisasi datepicker dengan tanggal bergabung yang sesuai
