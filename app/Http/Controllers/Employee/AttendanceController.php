...
class AttendanceController extends Controller
{
    ...
    // public function location(Request $request) {
    //     // Koordinat Ring Road Selatan di Panggungharjo, Sewon, Bantul, Yogyakarta
    //     $latitude = -7.841775;
    //     $longitude = 110.367918;
    
    //     $response = Http::get('https://nominatim.openstreetmap.org/reverse?format=geojson&lat='.$latitude.'&lon='.$longitude);
    
    //     $result = $response->json();
    
    //     if (isset($result['features'][0]['properties']['display_name'])) {
